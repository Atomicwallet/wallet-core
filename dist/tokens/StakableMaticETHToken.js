import MaticStakingManager from '../tokens/ABI/ERC-20/MaticStakingManager.js';
...
import ETHToken from './ETHToken.js';
import { StakingMixin, Web3Mixin } from '../coins/mixins/index.js';
...
export default class StakableMaticETHToken extends Web3Mixin(StakingMixin(ETHToken)) {
    ...
    async fetchStakingInfo() {
        ...
        const validators = Object.fromEntries(await Promise.all(this.predefinedValidators.map(async ({ address }) => {
            ...
            return [
                address,
                {
                    staked: new Amount(await this.makeRawCall(MaticValidatorsShare, address, 'balanceOf', [this.address]), this),
                    rewards: new Amount(await this.makeRawCall(MaticValidatorsShare, address, 'getLiquidRewards', [this.address]), this),
                    pendingWithdrawals,
        ...
        const availableVotes = new Amount(await this.makeRawCall(standard, this.contract, 'allowance', [this.address, this.stakingContract]), this);
        return {
...
//# sourceMappingURL=StakableMaticETHToken.js.map