import { WalletError, InsufficientFundsError } from '../../errors/index.js';
import { SEND_TRANSACTION_TYPE, WALLET_ERROR, LIB_NAME_INDEX } from '../../utils/const/index.js';
...
const BitcoinJSMixin = (superclass) => class extends superclass {
    ...
    async buildTx(inputs, address, amount, change, privateKey, otherSideAddr = undefined, version) {
        return new Promise(async (resolve, reject) => {
            ...
            // sign transaction
            await Promise.all(inputs.map(async (input, index) => this.signInput(txBuilder, keyForSign, index, input))).catch(reject);
            try {
...
//# sourceMappingURL=BitcoinJSMixin.js.map