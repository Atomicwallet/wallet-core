...
import { LazyLoadedLib, SEND_TRANSACTION_TYPE, WALLET_ERROR } from '../../utils/index.js';
...
const NeoMixin = (superclass) => class extends superclass {
    #privateKey;
    /**
     * Loads a wallet.
     *
    ...
    async sendTransaction(rawTx) {
        ...
        try {
            const { response: { result, txid: hash }, } = await coreLib.default.sendAsset({
...
//# sourceMappingURL=NeoMixin.js.map