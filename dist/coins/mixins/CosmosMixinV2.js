...
const getMessagesForSendType = ({ sendType, fromAddress, address: toAddress, delegatorAddress, validator, fromValidator = null, validatorsList = [], amount, denom, }) => {
...
const CosmosMixinV2 = (superclass) => class extends StakingMixin(superclass) {
     ...
     */
    async getFeeObjectWithMessages({ sendType, address, validator, fromValidator = null, validatorsList = [], amount, memo = '', }) {
    ...
    async getDifferentFromSpecifiedValidator(validatorAddress) {
        ...
        const differentFromSpecifiedValidator = predefinedValidators.find((validator) => validator.address !== validatorAddress);
...
//# sourceMappingURL=CosmosMixinV2.js.map