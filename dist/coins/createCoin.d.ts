import type { Coin, CoinConfigType } from '../abstract/index.js';
 ...
 */
export default function createCoin(CoinClass: unknown, coinData: CoinDataConfig, db?: IDataBase, configManager?: IConfigManager): Coin;
