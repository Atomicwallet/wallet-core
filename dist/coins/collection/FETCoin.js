...
const ADR_BECH32_PREFIX = 'fetch';
const DENOM_NAME = 'afet';
...
class FETCoin extends CosmosMixinV2(HasBlockScanner(HasProviders(Coin))) {
    /**
...
export default FETCoin;
//# sourceMappingURL=FETCoin.js.map