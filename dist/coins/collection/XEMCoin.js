...
import NemNodeExplorer from '../../explorers/collection/NemNodeExplorer.js';
...
class XEMCoin extends Coin {
    ...
    async createTransaction({ address, amount, memo = '' }) {
        ...
        const transferTransaction = nem.model.objects.create('transferTransaction')(address, this.toCurrencyUnit(amount), memo);
        const unsignedTransaction = nem.model.transactions.prepare('transferTransaction')(common, transferTransaction, networkId);
...
//# sourceMappingURL=XEMCoin.js.map