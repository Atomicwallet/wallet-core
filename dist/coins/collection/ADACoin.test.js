...
import ADACoin from '../../coins/collection/ADACoin.js';
...
const wallet = createCoin(ADACoin, config);
if (!wallet) {
    throw new Error(`Failed to initialize ${id} wallet`);
}
const generateMockUtxo = (index, receiver) => {
    return {
...
jest.spyOn(wallet, 'getUnspentOutputs').mockImplementation((address) => {
...
//# sourceMappingURL=ADACoin.test.js.map