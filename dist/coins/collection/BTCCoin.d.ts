 ...
 * @class BTCCoin
 */
declare class BTCCoin extends BTCCoin_base {
    /**
     ...
     */
    createTransaction({ address, amount, memo, userFee }: string): Promise<string>;
    getEstimatedTimeCfg(force?: boolean): Promise<any>;
    getEstimatedTimeTx(satPerByte: any, fieldName?: string): Promise<any>;
    availableBalance(fee: any): Promise<any>;
