...
import { BitcoinLikeFeeMixin, BitgoMixin } from '../mixins/index.js';
const NAME = 'ZCash';
const TICKER = 'ZEC';
...
class ZECCoin extends BitgoMixin(BitcoinLikeFeeMixin(Coin)) {
    ...
    constructor({ alias, notify, feeData, explorers, txWebUrl, socket, id }, db, configManager) {
        const config = {
            ...
            socket,
            dependencies: {
                [BITGO]: new LazyLoadedLib(() => import('bitgo-utxo-lib').then(({ default: coreLibrary }) => {
    ...
    async signInput(txBuilder, keyForSign, index, input) {
        const coreLibrary = await this.loadCoreLibrary();
        return txBuilder.sign(index, keyForSign, null, coreLibrary.Transaction.SIGHASH_ALL, input.satoshis, undefined, true);
    }
...
//# sourceMappingURL=ZECCoin.js.map