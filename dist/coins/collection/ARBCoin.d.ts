 ...
 */
declare class ARBCoin extends ARBCoin_base {
    /**
     ...
     * @returns {Promise<BN>}
     */
    getFee({ amount, address, contract, userGasPrice, gasLimit }?: {
     ...
     * @return {ARBToken}
     */
    createToken(args: object): ARBToken;
    /**
