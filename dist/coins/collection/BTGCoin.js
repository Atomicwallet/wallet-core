...
import { LIB_NAME_INDEX, WALLET_ERROR } from '../../utils/const/index.js';
...
class BTGCoin extends BitcoinJSMixin(BitcoinLikeFeeMixin(Coin)) {
    ...
    async addInput(txBuilder, input) {
        const bitcoinJs = await this.loadLib(BITCOINJS);
        txBuilder.addInput(input.txId, input.outputIndex, bitcoinJs.Transaction.DEFAULT_SEQUENCE, Buffer.from(input.script, 'hex'));
    }
    /**
     * Signs the input.
     *
...
//# sourceMappingURL=BTGCoin.js.map