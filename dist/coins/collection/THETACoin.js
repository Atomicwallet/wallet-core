...
import ThetaExplorer from '../../explorers/collection/ThetaExplorer.js';
import ThetaJSExplorer from '../../explorers/collection/ThetaJSExplorer.js';
...
class THETACoin extends HasProviders(HasTokensMixin(Coin)) {
    ...
    async createTransaction({ address, amount, nonce, ticker = this.ticker, userFee }) {
        ...
        return wallet.signTransaction(new transactions.SendTransaction({
            from: this.address,
            outputs: [
                {
                    address,
...
//# sourceMappingURL=THETACoin.js.map