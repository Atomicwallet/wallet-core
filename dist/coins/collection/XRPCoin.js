...
import RippleExplorer from '../../explorers/collection/RippleExplorer.js';
...
class XRPCoin extends Coin {
    ...
    async createClaimFlareTransaction(MessageKey) {
        ...
        const { validated_ledger: { seq: lastLedgerSequence }, } = await this.explorer.getServerInfo();
...
//# sourceMappingURL=XRPCoin.js.map