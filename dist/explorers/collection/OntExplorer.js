...
import { GET_TRANSACTIONS_TYPE, SEND_TRANSACTION_TYPE } from '../../utils/const/index.js';
class OntExplorer extends Explorer {
    ...
    async getTokenTransactions({ address, offset = 0, limit = this.defaultTxLimit, asset = 'ong' }) {
        const response = await this.request(this.getTokenTransactionsUrl(address), this.getTransactionsMethod(), this.getTransactionsParams(address, offset || 0, limit || this.defaultTxLimit), GET_TRANSACTIONS_TYPE, this.getTransactionsOptions());
...
//# sourceMappingURL=OntExplorer.js.map