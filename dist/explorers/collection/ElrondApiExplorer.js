...
class ElrondApiExplorer extends Explorer {
    ...
    modifyFetchStakingInfo(response) {
        const validators = response.reduce((validatorsObject, { contract: validator, userUnBondable: availableWithdrawals, userActiveStake: staked, claimableRewards: rewards, userUndelegatedList = [], }) => {
...
//# sourceMappingURL=ElrondApiExplorer.js.map