...
class HederaStakingExplorer extends Explorer {
    ...
    stake(wallet, nodeId, privateKey) {
        return this.#sendTx(this.#createAccountUpdateTx(wallet).setStakedNodeId(nodeId).setDeclineStakingReward(false), wallet, privateKey);
    }
    /**
     * Creates and sends stake tx
     * @param {Object} wallet The HBAR wallet
...
//# sourceMappingURL=HederaStakingExplorer.js.map