...
class EtherscanExplorer extends Explorer {
    ...
    async getTokensTransactions({ address, offset, limit, pageNum }) {
        ...
        const response = await this.request(this.getTransactionsUrl(), this.getTransactionsMethod(), this.getTokensTransactionsParams(address), GET_TRANSACTIONS_TYPE, this.getTransactionsOptions());
...
//# sourceMappingURL=EtherscanExplorer.js.map