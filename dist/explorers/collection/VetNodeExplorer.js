...
class VetNodeExplorer extends Explorer {
    ...
    async getTransactions({ address, offset = 0, limit = this.defaultTxLimit }) {
        ...
        const response = await this.request(this.getTransfersUrl(), this.getTransactionsMethod(), this.getTransfersParams(address, offset, limit), 'GetTxs', this.getTransactionsOptions());
...
//# sourceMappingURL=VetNodeExplorer.js.map