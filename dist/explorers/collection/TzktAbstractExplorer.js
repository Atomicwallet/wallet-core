...
class TzktAbstractExplorer extends Explorer {
    ...
    async getTransaction(selfAddress, txid) {
        const response = await this.request(this.getTransactionUrl(txid), this.getTransactionsMethod(), this.getTransactionsParams(selfAddress, undefined, 0), 'tx', this.getTransactionsOptions());
    ...
    async getTransactions({ address, pageNum, limit = this.defaultTxLimit }) {
        const txs = await this.request(this.getTransactionsUrl(address), this.getTransactionsMethod(), this.getTransactionsParams(address, limit, this.getExtraParam(pageNum, limit)), 'txs', this.getTransactionsOptions());
...
//# sourceMappingURL=TzktAbstractExplorer.js.map