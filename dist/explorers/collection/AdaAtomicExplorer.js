...
class AdaAtomicExplorer extends Explorer {
    ...
    async getAccountState(address) {
        return this.request(this.getAccountStateUrl(), 'get', { address }, this.getInfoOptions()).catch((error) => console.warn('Error', error));
    }
...
//# sourceMappingURL=AdaAtomicExplorer.js.map