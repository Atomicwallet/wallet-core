        ...
        try {
            ...
            if (operation) {
                if (operation.type === 'create_account') {
                    return super.modifyTransactionResponse(this.parseCreateAccountOperation(currentLedgerVersion, transaction, operation, selfAddress), selfAddress);
                }
                if (operation.type === 'payment') {
                    return super.modifyTransactionResponse(this.parsePaymentOperation(currentLedgerVersion, transaction, operation, selfAddress), selfAddress);
                }
            }
        }
        catch (error) {
...
//# sourceMappingURL=XlmExplorer.js.map