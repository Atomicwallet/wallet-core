...
class TezosNodeExplorer extends Explorer {
    ...
    async isValidator(address) {
        const response = await this.request(`${this.config.baseUrl}/chains/main/blocks/head/context/delegates/${address}`).catch((error) => console.warn(error));
        return !!response;
    }
...
//# sourceMappingURL=TezosNodeExplorer.js.map