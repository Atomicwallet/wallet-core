...
class VergeInsightExplorer extends Explorer {
    ...
    async getTransactions({ address, offset = 0, limit = this.defaultTxLimit, pageNum }) {
        const response = await this.request(this.getTransactionsUrl(address), this.getTransactionsMethod(), this.getTransactionsParams(address, offset || 0, limit || this.defaultTxLimit, pageNum), GET_TRANSACTIONS_TYPE, this.getTransactionsOptions());
        const txIds = [];
...
//# sourceMappingURL=VergeInsightExplorer.js.map