...
class TronNodeExplorer extends Explorer {
    ...
    async getInfo(address) {
        ...
        const rewardResponse = await this.request(this.getRewardUrl(), this.getRewardMethod(), this.getRewardParams(address), GET_BALANCE_TYPE, this.getInfoOptions());
    ...
    modifyInfoResponse(response) {
        ...
        const { balance = 0, frozen = [], votes = [], account_resource: accountResource = {}, reward = '0', assetV2, } = response || {};
...
//# sourceMappingURL=TronNodeExplorer.js.map