...
class NanocrawlerExplorer extends Explorer {
    ...
    async getTransactions(address, offset = 0, limit = this.defaultTxLimit) {
        const transactions = await this.request(this.getTransactionsUrl(address), this.getTransactionsMethod(), this.getTransactionsParams(offset, limit), GET_TRANSACTIONS_TYPE);
...
//# sourceMappingURL=NanocrawlerExplorer.js.map