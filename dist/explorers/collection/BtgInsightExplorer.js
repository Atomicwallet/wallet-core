...
class BtgInsightExplorer extends DgbInsightExplorer {
    ...
    async sendTransaction(rawtx) {
        const response = await axios.post(`${this.config.baseUrl}${this.getSendTransactionUrl()}`, `${this.getSendTransactionParam()}=${rawtx}`, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } });
        return this.modifyGeneralResponse(this.modifySendTransactionResponse(response));
    }
}
export default BtgInsightExplorer;
//# sourceMappingURL=BtgInsightExplorer.js.map