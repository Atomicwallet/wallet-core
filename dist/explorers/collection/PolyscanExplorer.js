import { POLYSCAN_API_KEY } from '../../env.js';
...
import { GET_BALANCE_TYPE, GET_TRANSACTIONS_TYPE } from '../../utils/const/index.js';
...
class PolyscanExplorer extends Explorer {
    ...
    async getTokenTransactions({ address }) {
        ...
        const response = await this.request(this.getTransactionsUrl(address), this.getTransactionsMethod(), tokenTXRequesParams, GET_TRANSACTIONS_TYPE, this.getTransactionsOptions());
...
//# sourceMappingURL=PolyscanExplorer.js.map