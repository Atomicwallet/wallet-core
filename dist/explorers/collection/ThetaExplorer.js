...
export default class ThetaExplorer extends Explorer {
    ...
    getTxFee(tx) {
        return this.wallet.toCurrencyUnit(Object.values(tx.data.fee).find((amount) => new this.wallet.BN(amount).gt(new this.wallet.BN(0))));
    }
    getTxFeeTicker(tx) {
        const { fee } = tx.data;
...
//# sourceMappingURL=ThetaExplorer.js.map