...
class TrongridExplorer extends Explorer {
    ...
    getAccountResource(address) {
        return this.request(this.getAccountResourceUrl(), this.getAccountResourceMethod(), this.getAccountResourceParams(address));
    }
    ...
    async getEstimatedEnergy(args) {
        const response = await this.request(this.getEstimatedEnergyUrl(), this.getEstimatedEnergyMethod(), this.getEstimatedEnergyParameters(args), 'TRX_ESTIMATE_ENERGY_REQUEST', { timeout: 10000 });
...
//# sourceMappingURL=TrongridExplorer.js.map