...
class BinanceBCExplorer extends Explorer {
        ...
        try {
            ...
            operations
                ...
                Object.keys(op).forEach((key) => {
                    validatorsMap.set(op.validator, {
    ...
    async fetchStakingInfo(address) {
        const [delegations, unbonding, rewardsInfo] = await Promise.all([
        ...
        const [unstake, totalStake, totalRewards] = ['unstaked', 'staked', 'rewards'].map((field) => Object.values(validators).reduce((acc, next) => acc.add(next[field].toBN()), new this.wallet.BN('0')));
        return {
...
//# sourceMappingURL=BinanceBCExplorer.js.map