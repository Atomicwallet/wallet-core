...
class KabutoExplorerV2 extends Explorer {
    ...
    async getInfo(address) {
        ...
        const response = await this.request(this.getInfoUrl(address), this.getInfoMethod(), this.getInfoParams(), GET_BALANCE_TYPE, this.getInfoOptions());
...
//# sourceMappingURL=KabutoExplorerV2.js.map