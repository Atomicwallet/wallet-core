...
class NearRPCExplorer extends Explorer {
    constructor(...args) {
        super(...args);
        this.getNodeConfig = lodash.throttle(this._getNodeConfig, THROTTLE_INTERVAL);
        this.getGasPrice = lodash.throttle(this._getGasPrice, THROTTLE_INTERVAL);
    ...
    async fetchStakingInfo(selfAddress, { activeValidators = [] } = {}) {
        ...
        const [unstaking, staked, availableWithdrawals, pendingWithdrawals] = [
            ...
            'pendingWithdrawals',
        ].map((field) => Object.values(validators).reduce((acc, validator) => {
...
//# sourceMappingURL=NearRPCExplorer.js.map