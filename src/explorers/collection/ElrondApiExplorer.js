...
class ElrondApiExplorer extends Explorer {
  ...
  modifyFetchStakingInfo (response) {
    ...
    const [staked, availableWithdrawals, pendingWithdrawals, rewards] = ['staked', 'availableWithdrawals', 'pendingWithdrawals', 'rewards']
