...
class ZilliqaAtomicExplorer extends ZilliqaAbstractExplorer {
  ...
  getTxType (tx) {
    switch (tx.operation) {
      case 'Claim rewards': return TxTypes.CLAIM
      case 'Stake': return TxTypes.STAKE
      case 'Unstake': return TxTypes.UNSTAKE
      case 'Withdraw stake': return TxTypes.WITHDRAW
      default: return TxTypes.TRANSFER
    }
  }
