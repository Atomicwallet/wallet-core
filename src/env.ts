...
export const DEFAULT_CHART_DATA_ENDPOINT = requiredEnv('DEFAULT_CHART_DATA_ENDPOINT');
...
export const ATOMIC_HEDERA_ACCOUNTS_SERVICE = requiredEnv('ATOMIC_HEDERA_ACCOUNTS_SERVICE');

/**
 * EXTERNAL API
 */
export const DEFAULT_IPFS_GATEWAY = requiredEnv('DEFAULT_IPFS_GATEWAY');
export const DEFAULT_ADALITE_SUBMIT_URL = requiredEnv('DEFAULT_ADALITE_SUBMIT_URL');
export const DEFAULT_BINANCE_NET_URL = requiredEnv('DEFAULT_BINANCE_NET_URL');
export const UNSTOPPABLEDOMAINS_API_BASE_URL = requiredEnv('UNSTOPPABLEDOMAINS_API_BASE_URL');
...
export const TONWEB_FALLBACK_INDEX_URL = requiredEnv('TONWEB_FALLBACK_INDEX_URL');
 ...
 * EXTERNAL API KEYS
 */
export const CHANGENOW_FALLBACK_API_KEY = requiredEnv('CHANGENOW_FALLBACK_API_KEY');
export const UNSTOPPABLEDOMAINS_API_KEY = requiredEnv('UNSTOPPABLEDOMAINS_API_KEY');
...
export const PURESTAKE_EXPLORER_API_KEY = requiredEnv('PURESTAKE_EXPLORER_API_KEY');
